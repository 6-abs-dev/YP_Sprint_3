...
public class HeatingSystemServiceImpl implements HeatingSystemService {
    ...
    public HeatingSystemDto createHeatingSystem(HeatingSystemDto heatingSystemDto) {
        ...
        newHeatingSystem.setId(heatingSystemDto.getId());
        newHeatingSystem.setOn(heatingSystemDto.isOn());
        newHeatingSystem.setTargetTemperature(heatingSystemDto.getTargetTemperature());
        HeatingSystem createdHeatingSystem = heatingSystemRepository.save(newHeatingSystem);
        return convertToDto(createdHeatingSystem);
    }
